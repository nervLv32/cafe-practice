...
(function ($, core, ui, undefined) {
    ...
    ui.LOAD_MANAGER = function () {
        ...
        this.events = {
            _init: function () {
                this._createHTML();
                core.observer.on("LOAD", this._hideLoading);
            },
            _createHTML: function () {
                $$.load = $("<div class='ui-load' style='display:none'><img src='../../img/square/loading.svg'/></div>");
    ...
    ui.SELECT = function () {
        ...
        this.events = {
            ...
            _inputSelect: function (e) {
                ...
                switch (opts.type) {
                    case "default":
                        opts.selectItems[0] = { idx: sIdx, text: $$.item.eq(sIdx).html() };
                        this._hideGroup();
                        break;
                    case "multi":
            ...
            _accessSelect: function () {
                ...
                /*! 2022-12-13 EZP-7627 disabled 추가 */
                $$.container.not('.disabled').toggleClass("active");
            },
    ...
    ui.POPUP = function () {
        ...
        this.events = {
            ...
            _close: function () {
                ...
                opts.is = false;
                /*! 2022-12-14 EZP-7627 닫기 버튼 클릭시 이동 막기 */
                // $$.container.focus(); 
            },
    ...
    ui.PARALLAX_ANIMATION = function () {
        ...
        var events = this.events = {
            ...
            _setStyle: function () {
                /*! 2022-12-13 EZP-7627 TweenMax 제거 */
                // $$.target.each(function (i) {

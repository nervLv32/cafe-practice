...
const DEST_PATH = {
  ...
  ASSETS: {
    CSS: config.dist + '/css/mobile',
    FONTS: config.dist + '/fonts/mobile',
    IMAGES: config.dist + '/img/mobile',
    VIDEO: config.dist + '/video',
    JS: config.dist + '/js',
    LIB: config.dist + '/js/ui/tree'
  }
}

...
(function($) {
	...
	$.fn.timepicki = function(options) {
		...
		return this.each(function() {
			...
			//FIXME: multiSelect.js $(document) click issue
			...
			function open_timepicki(e) {
				if(!e) return;

				var $calendarBox = ele_next.closest('.calendar-box');
			...
			function close_timepicki() {
				ele_next.fadeOut()
				.closest('.calendar-box').removeClass('active');
			}
